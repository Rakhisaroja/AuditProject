<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="AnnualPlanExpenditureDevelop_Urban.aspx.cs" Inherits="Pages_AnnualPlanExpenditureDevelop_Urban"  %>
        ...
        <tr>
          ...
          <%--   <asp:Label ID="intslno" runat="server" Text='<%# Eval("intslno") %>' />--%></td>
           ...
           <FooterTemplate></table></FooterTemplate>
                            ...
                            &nbsp;</td>
                        <%--<td> <asp:Label ID="label2" runat="server" Text="1" /></td>--%>
                        <td align="left"> <asp:Label ID="label5" runat="server" Text="കൂടിയ യോഗങ്ങളുടെ എണ്ണം"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  Font-Bold="True" Width="224px" /></td>
...
<FooterTemplate></table></FooterTemplate>
                        ...
                        </table></div></div></div></div></div></div></div></ContentTemplate></asp:UpdatePanel>
