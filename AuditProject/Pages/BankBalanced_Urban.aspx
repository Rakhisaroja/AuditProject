<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="BankBalanced_Urban.aspx.cs" Inherits="Pages_BankBalanced_Urban"   %>
...
<div class="content mt-3">
                ...
                <div class="title-blue-Head">വരവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <%--<strong class="card-titlen">II. 31.03.2017 ലെ  നീക്കിയിരിപ്പ് വിശദാംശം  (RP 40(a) പ്രകാരം)</strong>--%>
                            <strong class="card-titlen">II. നീക്കിയിരിപ്പ് വിശദാംശം  (RP 40(a) പ്രകാരം)</strong>
                        </div>
                        <div class="card-body">
    ...
    <ItemTemplate>
        <tr>
            ...
            <td><asp:TextBox ID="txtBalancd" ReadOnly="true"  runat="server" Text='<%# Eval("numobamount") %>' /></td>
             <td>
 ...
 <tr>  <td style="font-weight:bold">Total
        ...
        <td  >
            <asp:Label ID="obtot"  Font-Bold="True"  runat="server" Text='<%# Eval("obtot") %>' />
        </td><td></td>  <td  >
            <asp:Label ID="auditobtot"  Font-Bold="True"  runat="server" Text='<%# Eval("auditobtot") %>' />
        </td></tr>
    </table>
</FooterTemplate>    
...
</asp:Repeater><asp:Panel ID="f" runat="server" Visible="false">
<table style="width: 1200px" >    <tr>
        <td style="width: 200px">Total
            ...
            <td style=" width: 390px;text-align: right;" colspan="2">
            <asp:Label ID="obtot" runat="server" Text='<%# Eval("obtot") %>' Font-Bold="True" /></td> 
            <td style="width: 800px" colspan="2">
            <asp:Label ID="auditobtot" runat="server" Text='<%# Eval("auditobtot") %>' Font-Bold="True" />
        </td>
    </tr></table></asp:Panel>
                   ...
                   <table><tr><td></td></tr></table> 
                    <asp:Label ID="lblOBAmt" runat="server" Text="Label" Visible="False"></asp:Label>
                    <asp:Label ID="lblOBAuditAmt" runat="server" Text="Label" Visible="False"></asp:Label></div> 
                    <div style="width:100%">
