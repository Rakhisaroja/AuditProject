<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="BankClosed_Urban.aspx.cs" Inherits="Pages_BankClosed_Urban"  %>
            ...
            <div class="animated fadeIn">
                ...
                <div class="title-blue-Head">ചിലവിനം
                    ...
                    <div class="card-header">
                            <strong class="card-titlen">ഇ ) പൊതുസുരക്ഷയും ആരോഗ്യവും- തദ്ദേശഭരണസ്ഥാപനങ്ങളുടെ ഇതരസേവനങ്ങളുടെ വിവരങ്ങള്‍</strong>
                        </div>
                        <div class="card-header">
                           <%-- <strong class="card-titlen">10.    31.03.18 ലെ വിവിധ ഇനങ്ങളിലെ നീക്കിയിരിപ്പ് (40(b)പ്രകാരം)</strong>--%>
                            <strong class="card-titlen">10. വിവിധ ഇനങ്ങളിലെ നീക്കിയിരിപ്പ് (40(b)പ്രകാരം)</strong>
                        </div>
                        <div class="card-body">
...
<div class="card-header">
                            <strong class="card-titlen">പരിശോധനാ സൂചകം : RP40(b) പരിശോധിച്ച് ക്യത്യത ഉറപ്പാക്കുക</strong>
                        </div>
