<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="CentralFund.aspx.cs" Inherits="Pages_CentralFund"   %>
                ...
                <div class="col-md-12">
                    <div class="title-blue-Head">വരവ് ഭാഗം
                      ...
                      <tr>
                       ...
                       <td><asp:TextBox ID="txtIncm" runat="server" Text= "" CssClass="floatnumbers" Width="176px" />
                      </td>
                       ...
                       <td><asp:TextBox ID="txtexp" runat="server" Text= "" Width="176px"  CssClass="floatnumbers" /></td>
                        </tr>
                        <tr>
                         <td   style="width:50px">
                            &nbsp;</td>
