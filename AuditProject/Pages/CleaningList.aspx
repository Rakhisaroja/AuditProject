<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="CleaningList.aspx.cs" Inherits="Pages_CleaningList"   %>
                         ...
                         <th colspan="2" align="center" >
                            ...
                            <tr>
                                ...
                                <td align="center" colspan="3">
                                    <asp:Label ID="Label18" runat="server" Text="ഖര ദ്രവ മാലിന്യ സംസ്കരണ സംവിധാനങ്ങളുടെ വിവരങ്ങള്‍     ( ഗ്രാ.പ / വിട്ടുകിട്ടിയവ / കമ്മ്യൂണിറ്റി തലത്തിലുള്ളവയുടെ എണ്ണം)" Font-Bold="True" Width="661px" /></td>
                            </tr>
                            <tr>
                                <td style="width: 80px">
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" id="TD1" runat="server">
                                    <asp:TextBox ID="txtMechPlantexist"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                                <td align="left" style="width: 381px; height: 28px">
                                    <asp:TextBox ID="txtAuditMechPlantexist" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                <td style="width: 80px;">
                                </td>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtBiogasexist" runat="server" Text= ""  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Width="120px" MaxLength="5" /></td>
                                <td align="left" style="width: 381px; height: 28px">
                                    <asp:TextBox ID="txtAuditBiogasexist"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                <td style="width: 80px;">
                                </td>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtVerni" runat="server"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text= "" Width="120px" MaxLength="5" /></td>
                                <td align="left" style="width: 381px; height: 28px">
                                    <asp:TextBox ID="txtAuditvermiexist"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" style="height: 29px">
                                    <asp:TextBox ID="txtMechaNew"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                                <td align="left" style="width: 381px; height: 29px">
                                    <asp:TextBox ID="txtAuditMechaNew"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" style="height: 29px">
                                    <asp:TextBox ID="txtBiogasNew"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                                <td align="left" style="width: 381px; height: 29px">
                                    <asp:TextBox ID="txtAuditBiogasNew"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtVemiNew" runat="server"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text= "" Width="120px" MaxLength="5" /></td>
                                <td align="left" style="width: 381px; height: 62px">
                                    <asp:TextBox ID="txtAuditVemiNew"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="120px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                <td style="width: 80px;">
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 164px; height: 28px">
                                    <asp:Label ID="Label3" runat="server" Text="കേ.പരാ.ആക്ട് 219(x) വകുപ്പ് (സര്‍ക്കുലര്‍ നം  576/ഡി.സി1/16/തസ്വഭവ , 24.09.16) പ്രകാരം ശുചിത്വത്തിന് ഫണ്ട് രൂപീകരിച്ചിട്ടുണ്ട് / ഇല്ല" Font-Bold="True" Width="520px" /></td>
                                <td align="left" style="height: 28px">
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 164px; height: 28px">
                                    <asp:Label ID="Label27" runat="server" Text="പ്രോജക്ടില്‍ ഉല്‍പ്പെടുതാതെ ചെലവഴിച്ച തുകയുടെ വിവരം" Font-Bold="True" Width="488px" /></td>
                                <td align="left" style="height: 28px">
                                    <asp:TextBox ID="txtnoplanAmt" runat="server" CssClass="floatnumbers" Text= "" Width="250px" TextMode="MultiLine" /></td>
                                <td align="left" style="width: 381px; height: 28px">
                                    <asp:TextBox ID="txtAuditnoplanAmt" CssClass="floatnumbers" runat="server" Text= "" Width="250px" TextMode="MultiLine" /></td>
                            </tr>
                            <tr>
                                <td style="width: 80px;">
                                </td>
                                <td align="left" style="width: 164px; height: 28px">
                                    <asp:Label ID="Label28" runat="server" Text="ഉപോത്പനങ്ങളുടെ വില്‍പനയില്‍ നിന്നും ലഭിച്ചിട്ടുള്ള വരുമാനത്തിന്റെ വിവരം (വെര്‍മി കമ്പോസ്റ്റ്, മണ്ണിര കമ്പോസ്റ്റ് മുതലായവ)" Font-Bold="True" Width="520px" /></td>
                                <td align="left" style="height: 28px">
                            ...
                            <tr>
                                ...
                                <td align="left" style="height: 28px">
                                    <asp:TextBox ID="txtByProdAmt" runat="server" Text= "" CssClass="floatnumbers" Width="250px" TextMode="MultiLine" /></td>
                                <td align="left" style="width: 381px; height: 28px">
                                    <asp:TextBox ID="txtAuditByProdAmt" runat="server" CssClass="floatnumbers" Text= "" Width="250px" TextMode="MultiLine" /></td>
                            </tr>
