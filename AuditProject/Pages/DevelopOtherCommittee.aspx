<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="DevelopOtherCommittee.aspx.cs" Inherits="Pages_DevelopOtherCommittee"  %>
                    ...
                    <div class="card">
                       ...
                       <%-- <th  >ക്രമ നമ്പര്‍</th>--%> <td   style="width:50px">
                        ...
                        <td style="width: 362px; height: 28px;" align="left"  > 
                           <asp:Label ID="Label2" runat="server" Text="2. പ്രവര്‍ത്തന മേഖല" Font-Bold="True" Width="152px" /><span style="color: #000000"><strong>(*)</strong></span></td>
                       <td align="left"><asp:TextBox ID="txtoperational"   runat="server" Text= "" Width="413px" /></td>
                          ...
                          <td   style="width:50px">
                            &nbsp;</td>
                        <td style="width: 362px; height: 28px;" align="left" > 
                            <asp:Label ID="Label3" runat="server" Text="3. യോഗ വിവരം" Font-Bold="True" Width="144px" Height="32px" /><span style="color: #000000"><strong>(*)</strong></span>
                        </td>
