<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="DevelopWorkingGroup_Urban.aspx.cs" Inherits="Pages_DevelopWorkingGroup_Urban"  %>
                ...
                <div class="title-blue-Head">ചെലവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                         ...
                         <div><asp:Button id="btnNew" onclick="btnNew_Click" runat="server" Text="NEW & EDIT" Width="100px" CssClass="btn btn-secondary btn-sm"></asp:Button></div>
                        <%--BKJKBJK --%>
                          <div class="card-body">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td align="left" style="width: 362px; height: 28px">
                                    <strong> <span lang="ML" style="font-size: 12pt; color: #000000; font-family: Meera;
                                        mso-fareast-font-family: Calibri; mso-ansi-language: EN-GB; mso-fareast-language: EN-GB;
                                        mso-bidi-language: ML"><strong><asp:Label ID="Label8" runat="server" Text="8.മുനിസിപ്പാലിറ്റി/കോര്‍പ്പറേഷന്‍ തീരപ്രദേശ മേഖലയിലാണോ സ്ഥിതി ചെയ്യുന്നത് ?" Font-Bold="True" Width="310px" />(*)</strong></span></strong></td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlplace" runat="server" Width="98px">
                                        <asp:ListItem Value="0">----</asp:ListItem>
                                        <asp:ListItem Value="1">അതെ</asp:ListItem>
                                        <asp:ListItem Value="2">അല്ല</asp:ListItem>
                                    </asp:DropDownList></td>
                             ...
                             <tr>
                                ...
                                <td align="left" style="width: 362px; height: 28px">
                                    <strong> <span lang="ML" style="font-size: 12pt; color: #000000; font-family: Meera;
                                        mso-fareast-font-family: Calibri; mso-ansi-language: EN-GB; mso-fareast-language: EN-GB;
                                        mso-bidi-language: ML"><strong><asp:Label ID="Label9" runat="server" Text="9.മുനിസിപ്പാലിറ്റി/കോര്‍പ്പറേഷനില്‍ ഫിഷറീസ് ഇൻസ്‌പെക്ടർ നിലവിലുണ്ടോ ?" Font-Bold="True" Width="310px" />(*)</strong></span></strong></td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlinspector" runat="server" Width="98px">
                                        <asp:ListItem Value="0">----</asp:ListItem>
                                        <asp:ListItem Value="1">ഉണ്ട്</asp:ListItem>
                                        <asp:ListItem Value="2">ഇല്ല</asp:ListItem>
                                    </asp:DropDownList></td>
                             ...
                             <tr>
                                ...
                                <td align="left" style="width: 362px; height: 28px">
                                    <strong> <span lang="ML" style="font-size: 12pt; color: #000000; font-family: Meera;
                                        mso-fareast-font-family: Calibri; mso-ansi-language: EN-GB; mso-fareast-language: EN-GB;
                                        mso-bidi-language: ML"><strong><asp:Label ID="Label10" runat="server" Text="10.മത്സ്യമേഖല വികസനത്തിന് പ്രത്യേക വര്‍ക്കിംഗ് ഗ്രൂപ്പ് ഉണ്ടോ ?ഉണ്ടെങ്കില്‍ വിശദാംശങ്ങള്‍" Font-Bold="True" Width="310px" />(*)</strong></span></strong></td>
                                 <td align="left"><asp:TextBox ID="txtfishwg"  runat="server" Text= "" Width="413px" /></td>
        ...
        <tr> <th scope="col"  rowspan="2" align="center"  >
            ...
            <tr>
                ...
                മോണിറ്ററിംഗ് റിപ്പോര്‍ട്ട് തയ്യാറാക്കിയിട്ടുണ്ട് / ഇല്ല
                   ...
                   <th scope="col" style="width: 100px" align="center">
               മുനിസിപ്പാലിറ്റി/കോര്‍പ്പറേഷന്‍ തീരപ്രദേശ മേഖലയിലാണോ സ്ഥിതി ചെയ്യുന്നത് ?
                </th>
                  
                   <th scope="col" style="width: 100px" align="center">
              മുനിസിപ്പാലിറ്റി/കോര്‍പ്പറേഷനില്‍ ഫിഷറീസ് ഇന്‍പെക്ടര്‍ നിലവിലുണ്ടോ ?
                </th>
                  
                  
                  <th scope="col" style="width: 100px" align="center">
             മത്സ്യമേഖല വികസനത്തിന് പ്രത്യേക വര്‍ക്കിംഗ് ഗ്രൂപ്പ് ഉണ്ടോ ?ഉണ്ടെങ്കില്‍ വിശദാംശങ്ങള്‍
                </th>
    ...
    <ItemTemplate>
            ...
            <td><asp:DropDownList ID="tnymonitoringcommittee" runat="server"   Width="98px">
               ...
               <%-- <asp:TextBox ID="tnymonitoringreport" runat="server" Text='<%# Eval("tnymonitoringreport") %>' />--%>
                ...
                <td>
               <asp:DropDownList ID="tnyCoastalArea" runat="server"   Width="98px">
                                        <asp:ListItem Value="0">----</asp:ListItem>
                                        <asp:ListItem Value="1">ഉണ്ട്</asp:ListItem>
                                        <asp:ListItem Value="2">ഇല്ല</asp:ListItem>
                                    </asp:DropDownList>
            ...
            <td>
               <asp:DropDownList ID="tnyfisheInspector" runat="server"   Width="98px">
                                        <asp:ListItem Value="0">----</asp:ListItem>
                                        <asp:ListItem Value="1">ഉണ്ട്</asp:ListItem>
                                        <asp:ListItem Value="2">ഇല്ല</asp:ListItem>
                                    </asp:DropDownList>
                <%--<asp:TextBox ID="tnyAuditmonitoringreport" runat="server" Text='<%# Eval("tnyAuditmonitoringreport") %>' />--%>
                        ...
                        <td><asp:TextBox ID="txtfishZoneDev"  Width="300px"  runat="server" Text='<%# Eval("fishZoneDev") %>' /></td>
        ...
        <td><asp:Label ID="TextBox1"  Width="300px" runat="server" Text='<%# Eval("nchvWorkingGroup") %>' />
            ...
            <td><asp:DropDownList ID="tnyAuditmonitoringcommittee" runat="server"   Width="98px">
             ...
             <td>
               <asp:DropDownList ID="tnyAuditCoastalArea" runat="server"   Width="98px">
                                        <asp:ListItem Value="0">----</asp:ListItem>
                                        <asp:ListItem Value="1">ഉണ്ട്</asp:ListItem>
                                        <asp:ListItem Value="2">ഇല്ല</asp:ListItem>
                                    </asp:DropDownList>
             ...
             <td>
               <asp:DropDownList ID="tnyAuditfisheInspector" runat="server"   Width="98px">
                                        <asp:ListItem Value="0">----</asp:ListItem>
                                        <asp:ListItem Value="1">ഉണ്ട്</asp:ListItem>
                                        <asp:ListItem Value="2">ഇല്ല</asp:ListItem>
                                    </asp:DropDownList>
            ...
            <td><asp:TextBox ID="txtAuditfishZoneDev"  Width="300px"  runat="server" Text='<%# Eval("AuditfishZoneDev") %>' /></td>
