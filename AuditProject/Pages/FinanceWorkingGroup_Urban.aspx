<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="FinanceWorkingGroup_Urban.aspx.cs" Inherits="Pages_FinanceWorkingGroup_Urban"  %>
                ...
                <div class="title-blue-Head">ചെലവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <strong class="card-titlen">എ (i) വര്‍ക്കിംഗ് ഗ്രൂപ്പുകള്‍</strong>
                        </div>
