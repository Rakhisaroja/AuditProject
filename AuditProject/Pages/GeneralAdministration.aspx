<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="GeneralAdministration.aspx.cs" Inherits="Pages_GeneralAdministration" %>
            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen">i. പൊതുഭരണം</strong>
    ...
    <table width="100%" border="1">
        ...
        <tr>
            ...
            <span style="font-size: 12pt;font-family:Meera">
                            <strong>തദ്ദേശഭരണസ്ഥാപനം സ്ഥിതി ചെയ്യുന്ന ജില്ല</strong></span></td>
        ...
        <tr>
            <td style="width: 300px">
               <span style="font-size: 12pt;font-family:Meera">
                    <strong>തദ്ദേശഭരണസ്ഥാപനം സ്ഥിതി ചെയ്യുന്ന താലൂക്ക് </strong></span>
            </td>
        ...
        <tr>
            <td style="width: 300px">
             <span style="font-size: 12pt;font-family:Meera"><strong> സ്ഥിതി ചെയ്യുന്ന നിയോജകമണ്ഡലം</strong></span>
            </td>
            <td style="width: 117px">
        ...
        <tr>
            <td style="width: 300px;">
               <span style="font-size: 12pt;font-family:Meera"><strong>തദ്ദേശഭരണസ്ഥാപനത്തിന്‍റെ അതിരുകള്‍</strong></span>
            </td>
            <td style="width: 300px">
        ...
        <tr>
            <td style="width: 300px">
                <span style="font-size: 12pt;font-family:Meera">
                   <strong>തദ്ദേശഭരണസ്ഥാപനത്തിന്‍റെ ആകെ വിസ്തീര്‍ണം (ച.കി)</strong></span>
            </td>
            <td align="left">
               <%-- <asp:Label ID="lblArea" runat="server"></asp:Label>--%>
               <asp:TextBox ID="txtArea" runat="server" ReadOnly="True" CssClass="floatnumbers"></asp:TextBox>
                </td>
            <td>
        ...
        <tr>
            <td style="width: 300px;">
                <span style="font-size: 12pt;font-family:Meera">
             <strong> തദ്ദേശഭരണസ്ഥാപനത്തിന്‍റെ ആകെ ജനസംഖ്യ </strong></span>
...
<%--                <asp:Label ID="lblMale" runat="server" Text="ആണ്:" Font-Names="Meera" Width="51px"></asp:Label>
            ...
            <td style="width: 180px">
                ...
                <asp:TextBox ID="txtMaleAud" runat="server" Width="100px" ReadOnly="True" CssClass="floatnumbers"></asp:TextBox>--%>
                 <table><tr><td style="width: 167px">
                <asp:Label ID="lblMale" runat="server" Font-Names="Meera" Text="ആണ്:"></asp:Label></td>
               <td style="width: 214px" align="left"> <asp:TextBox ID="txtMale" onkeypress="return  isNumberKey(event)"  CssClass="txtBoxNumeric"  runat="server" Width="200px" ReadOnly="True" TextMode="MultiLine"></asp:TextBox></td></tr>
                <tr><td style="width: 167px"><asp:Label ID="Label29" runat="server" Font-Names="Meera" Text="പെണ്ണ്:" Width="88px"></asp:Label></td>
               <td style="width: 214px" align="left"> <asp:TextBox ID="txtFemale" onkeypress="return  isNumberKey(event)"  CssClass="txtBoxNumeric"  runat="server" Width="200px" ReadOnly="True" ></asp:TextBox>
                
                </td></tr></table>
            </td><td><table><tr><td style="width: 167px" align="left"> <asp:TextBox ID="txtMaleAud" onkeypress="return  isNumberKey(event)"  CssClass="txtBoxNumeric" runat="server" Width="200px" ReadOnly="True" TextMode="MultiLine"></asp:TextBox></td></tr><tr>
            <td align="left"> <asp:TextBox ID="txtFemaleAud" onkeypress="return  isNumberKey(event)"  CssClass="txtBoxNumeric" runat="server" Width="200px" ReadOnly="True" ></asp:TextBox>
 ...
 <%--               <asp:Label ID="lblFemale" runat="server" Text="പെണ്ണ്:" Font-Names="Meera" color="black" Width="51px" ></asp:Label>
        ...
        <tr>
            <td style="width: 300px">
                ...
                പ്രസിഡന്റ് /ചെയർമാൻ /ചെയർപേഴ്സൺ /മേയർ പേര്, കാലയലവ്</strong></span>
            </td>
        ...
        <tr>
            <td style="width: 300px">
             <span style="font-size: 12pt;font-family:Meera"><strong>ആരോഗ്യ വിദ്യാഭ്യാസ സ്റ്റാന്റിംഗ് കമ്മിറ്റി
        ...
        <tr>
            <td style="width: 300px">
                <span style="font-size: 12pt;font-family:Meera"><strong>
                    സെക്രട്ടറിയുടെ പേര് ,കാലയളവ്</strong></span></td>
            <td style="width: 200px">
