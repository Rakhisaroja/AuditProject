<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="GramasabhaDetails_Urban.aspx.cs" Inherits="Pages_GramasabhaDetails_Urban"  %>
               ...
               <%-- <div class="title-blue-Head">വരവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen">I.(v)വാര്‍ഡ്സഭ വിവരങ്ങള്‍</strong>
                        </div>
                       ...
                       <tr><td>പുരുഷന്‍</td><td><asp:TextBox ID="txtnoofMaleParicipate" runat="server" Text= "" Width="100px" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" /></td></tr></table></td>
                          ...
                          <td   style="width:50px">
                            &nbsp;</td>
                        <td style="width: 279px; height: 28px;" align="left"  > 
                            <strong>4. യോഗം ചേര്‍ന്ന സ്ഥലം (*)</strong></td>
