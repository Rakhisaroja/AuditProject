<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="HealthOtherCommittee.aspx.cs" Inherits="Pages_HealthOtherCommittee"  %>
            ...
            <div class="animated fadeIn">
                ...
                <div class="title-blue-Head">ചെലവ് ഭാഗം
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <strong class="card-titlen">ഡി(ii) മറ്റ് കമ്മിറ്റികള്‍ യോഗങ്ങള്‍
</strong>
                        </div>
