<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="HouseDetails_Urban.aspx.cs" Inherits="Pages_HouseDetails_Urban"   %>
...
<div class="content mt-3">
        ...
        <tr> 
            ...
            <tr>
               ...
               മെ.ഫ
                  ...
                  <%-- <th scope="col" style="width: 100px" align="center" visible="false">
                  മറ്റുള്ളവ
                </th>--%>
                </th>
                   <%--<th scope="col" style="width: 100px" align="center" visible="false">
    ...
    <ItemTemplate>
        ...
        <asp:TextBox ID= "fltDevFund" runat="server"  Text='<%# Eval("fltDevFund") %>'  CssClass="floatnumbers"   ReadOnly="true" />
            ...
            <%--<td>
                <asp:TextBox ID= "fltOtherFund" runat="server" Text='<%# Eval("fltOtherFund") %>' CssClass="floatnumbers"  ReadOnly="true" Visible="false" />
            </td>
              <td>
                <asp:TextBox ID= "fltTotal" runat="server" Text='<%# Eval("fltTotal") %>' CssClass="floatnumbers"  ReadOnly="true"  Visible="false"/>
            </td>--%>
            <td>
      ...
      <asp:TextBox ID= "fltDevFundExp" runat="server" Text='<%# Eval("fltDevFundExp") %>' CssClass="floatnumbers"  ReadOnly="true"  />
             ...
             <td>
                <asp:TextBox ID= "fltOwnFundExp" runat="server"  Text='<%# Eval("fltOwnFundExp") %>' CssClass="floatnumbers"  ReadOnly="true" />
                 ...
                 <%--<td>
                  <asp:TextBox ID= "fltOtherFundExp" runat="server"  Text='<%# Eval("fltOtherFundExp") %>'  CssClass="floatnumbers"  ReadOnly="true"  Visible="false"/>
                
            
            </td>
            
              <td>
                <asp:TextBox ID= "fltTotalExp" runat="server" Text='<%# Eval("fltTotalExp") %>' CssClass="floatnumbers"  ReadOnly="true"  Visible="false" />
            </td>--%>
           ...
           <%-- <td>
                <asp:TextBox ID= "fltaudOtherFund" runat="server" Text='<%# Eval("fltaudOtherFund") %>' CssClass="floatnumbers"  ReadOnly="true" Visible="false" />
            </td>
              <td>
                <asp:TextBox ID= "fltaudTotal" runat="server" Text='<%# Eval("fltaudTotal") %>' CssClass="floatnumbers"  ReadOnly="true" Enabled="false" Visible="false"/>
            </td>--%>
            <td>
            ...
            <%--<td>
                <asp:TextBox ID= "fltaudOtherFundExp" runat="server" Text='<%# Eval("fltaudOtherFundExp") %>' CssClass="floatnumbers"  ReadOnly="true" Visible="false" />
            </td>
            
            <td>
                <asp:TextBox ID= "fltaudTotalExp" runat="server" Text='<%# Eval("fltaudTotalExp") %>' CssClass="floatnumbers"  ReadOnly="true"  Enabled="false" Visible="false"/>
            </td>--%>
            </td>
           </tr></ItemTemplate>
...
function isNumberKey(evt)
 ...
 <script type="text/javascript">
function validatenumericamount(objectid, kbevent) {
