<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="JobGivenDetails.aspx.cs" Inherits="Pages_JobGivenDetails" Title="Untitled Page" %>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <%--  <div class="table table-striped table-bordered">--%>
                        <table  >
                         <tr><td align="center" >
                            <asp:Panel  ID="pnlRej" runat="server"  >
