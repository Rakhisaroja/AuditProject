<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="JointVentureDetails_Urban.aspx.cs" Inherits="Pages_JointVentureDetails_Urban" %>
...
<div class="content mt-3">
                    ...
                    <div class="title-blue-Head">വരവ് ഭാഗം
                        ...
                        <div class="card">
                          <div class="card-header">
                                <strong class="card-titlen">VII. നഗരാസൂത്രണ പദ്ധതികള്‍ക്ക്  മറ്റ് സര്‍ക്കാര്‍ ഏജന്‍സികളില്‍ നിന്നും ലഭിച്ച തുകയുടെ വിവരം</strong>
    ...
    <ItemTemplate>
         ...
         <%--   <asp:Label ID="Label1" runat="server" Text='<%# Eval("chvincometypemal") %>' />--%>
            ...
            <td>
             ...
             <td>
                <asp:TextBox ID= "numBalance" runat="server"  ReadOnly="true" Text='<%# Eval("numBalance") %>' CssClass="floatnumbers" />
            </td>
         ...
         <%--   <asp:Label ID="Label1" runat="server" Text='<%# Eval("chvincometypemal") %>' />--%>
            ...
            <td>
                <asp:TextBox ID= "numAuditBalance" runat="server"  ReadOnly="true" Text='<%# Eval("numAuditBalance") %>' CssClass="floatnumbers" />
            </td>
 ...
 <tr>  <td style="font-weight:bold" colspan="2" >Total
       ...
       <td></td>  <td  >
         ...
         <td  >
            <asp:Label ID="totnumauditbalance"  Font-Bold="True"  runat="server" Text='<%# Eval("totnumauditbalance") %>'  />
        </td>
      </tr>
    </table>
</FooterTemplate>  
