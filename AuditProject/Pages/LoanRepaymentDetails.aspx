<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="LoanRepaymentDetails.aspx.cs" Inherits="Pages_LoanRepaymentDetails" %>
                    ...
                    <div class="title-blue-Head">വരവ് ഭാഗം
                      ...
                      <tr>
                        ...
                        <td style="width: 279px; height: 28px;" align="left"  > 
                            <strong>വര്ഷികാരംഭത്തില്‍
തിരികെ ലഭിക്കാനുണ്ടായിരുന്ന തുക</strong></td>
                       <td><asp:TextBox ID="txtOB" runat="server" Text= "" Width="176px"  CssClass="floatnumbers"/></td>
                        </tr>
                       ...
                       <td><asp:TextBox ID="txtrecurrentpayment" runat="server" Text= "" Width="176px"  CssClass="floatnumbers"/>
                      </td>
                       ...
                       <td><asp:TextBox ID="Txtcurrentreceipt" runat="server" Text= "" Width="176px"  CssClass="floatnumbers"/></td>
                        </tr>
                       ...
                       <td><asp:TextBox ID="TxtBal" runat="server" Text= "" Width="176px"  CssClass="floatnumbers"/></td>
                        </tr>
    ...
    <ItemTemplate>
         ...
         <%--   <asp:Label ID="Label1" runat="server" Text='<%# Eval("chvincometypemal") %>' />
            ...
            <td><asp:TextBox ID= "numob" runat="server" Text='<%# Eval("numob") %>'  CssClass="floatnumbers" ReadOnly="true"/></td>
             <td>
                <asp:TextBox ID= "numrecurrentpayment" runat="server" Text='<%# Eval("numrecurrentpayment") %>'  CssClass="floatnumbers" ReadOnly="true"/>
            </td>
            <td>
                <asp:TextBox ID= "numcurrentreceipt" runat="server" Text='<%# Eval("numcurrentreceipt") %>'  CssClass="floatnumbers" ReadOnly="true"/>
            </td>
             <td>
           ...
           <%-- <asp:Label ID="Label2" runat="server" Text='<%# Eval("chvincometypemal") %>' />
            ...
            <asp:Label ID="Label5" runat="server" Text='<%# Eval("vchaccountheadcode") %>' Visible="false" />
             ...
             <td>
                <asp:TextBox ID= "numauditedrecurrentpayment" runat="server"  Text='<%# Eval("numauditedrecurrentpayment") %>' ReadOnly="true"  CssClass="floatnumbers"/>
                 <td>
                  <asp:TextBox ID= "numauditedcurrentreceipt" runat="server"  Text='<%# Eval("numauditedcurrentreceipt") %>'  ReadOnly="true" CssClass="floatnumbers"/>
                 <td>
                <asp:TextBox ID= "numauditedbalance" runat="server"  Text='<%# Eval("numauditedbalance") %>' ReadOnly="true"  CssClass="floatnumbers"/>
                 <td>
