<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="LocalDevolopmnetDet_Urban.aspx.cs" Inherits="Pages_LocalDevolopmnetDet_Urban"  %>
                    ...
                    <div class="title-blue-Head">വരവ് ഭാഗം
                      ...
                      <div class="card-header">
                            <strong class="card-titlen">
                               6.പ്രാദേശികസാമ്പത്തിക വികസനം</strong>
                        </div>
...
<div> <table width="100%"> <tr> <td style="width: 1200px; height: 51px;" align="Center" colspan="3">
 <asp:Button ID="btnBack" runat="server" CssClass="btn btn-secondary btn-sm" OnClick="btnBack_Click"
                               ...
                               <asp:Button
                                    ...
                                    TabIndex="10"
                                    Text="SAVE" />
                                      <asp:Button ID="btnNxt" runat="server" Visible="false"  CssClass="btn btn-secondary btn-sm" OnClick="btnNxt_Click"
