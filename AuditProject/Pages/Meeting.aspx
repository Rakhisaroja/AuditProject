<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="Meeting.aspx.cs" Inherits="Pages_Meeting" %>
                   ...
                   <%-- <div class="title-blue-Head">വരവ് ഭാഗം
                        ...
                        <div class="card">
                           <div class="card-header">
                                <strong class="card-titlen">I.ii യോഗനടപടികളുടെ വിവരം</strong>
                       ...
                       <%-- <th  >ക്രമ നമ്പര്‍</th>--%> <td   style="width:50px">
                        ...
                        <td style="width: 350px; height: 28px;" align="left"> <asp:Label ID="label1" runat="server" Text="യോഗം ചേര്‍ന്ന തീയതി " Font-Bold="True" />
                            (*)</td>
                        <td style="width: 381px; height: 28px;" align="left"><asp:TextBox ID="dtMeetingDate" runat="server" Text= "" Width="176px"  CssClass="txtDate"  /></td>
                        </tr>
                      ...
                      <tr>
                       ...
                       <td><asp:TextBox ID="txtAttndnceCnt" runat="server" Text= "" Width="176px"  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  /></td>
                        </tr>
                       ...
                       <td><asp:TextBox ID="txtMtnCnt" runat="server" Text= "" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Width="176px" />
                      </td>
