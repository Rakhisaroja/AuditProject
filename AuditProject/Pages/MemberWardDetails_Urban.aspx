<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="MemberWardDetails_Urban.aspx.cs" Inherits="Pages_MemberWardDetails_Urban"  %>
                ...
                <%--<div class="title-blue-Head">വരവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen">I.(iii)നിയോജകമണ്ഡലങ്ങളുടെ/വാര്‍ഡുകളുടെ വിവരം</strong>
                        </div>
                        <div class="card-body">
