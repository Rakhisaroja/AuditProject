<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="PensionDetails_Urban.aspx.cs" Inherits="Pages_PensionDetails_Urban" %>
...
<div class="content mt-3">
    ...
    <ItemTemplate>
            ...
            <td><asp:TextBox ID= "intapplicationcount" runat="server" Text='<%# Eval("intapplicationcount") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  ReadOnly="true" /></td>
             <td>
                <asp:TextBox ID= "intapprovedwithintimelimit" runat="server" Text='<%# Eval("intapprovedwithintimelimit") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  ReadOnly="true" />
            </td>
            <td>
                <asp:TextBox ID= "intapprovedaftertimelimit" runat="server" Text='<%# Eval("intapprovedaftertimelimit") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  ReadOnly="true" />
            </td>
             <td>
               <asp:TextBox ID= "intrejected" runat="server" Text='<%# Eval("intrejected") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  ReadOnly="true" />
            </td>
            ...
            <td>
             ...
             <td>
                 <asp:TextBox ID= "intapplicationcountaudited" runat="server"  Text='<%# Eval("intapplicationcountaudited") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  ReadOnly="true" />
            </td>
             <td>
                <asp:TextBox ID= "intapprovedwithintimelimitaudited" runat="server"  Text='<%# Eval("intapprovedwithintimelimitaudited") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"  ReadOnly="true" />
                 <td>
                  <asp:TextBox ID= "intapprovedaftertimelimitaudited" runat="server"  Text='<%# Eval("intapprovedaftertimelimitaudited") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"   ReadOnly="true" />
                 <td>
                <asp:TextBox ID= "intrejectedaudited" runat="server"  Text='<%# Eval("intrejectedaudited") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"   ReadOnly="true" />
