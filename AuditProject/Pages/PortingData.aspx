<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="PortingData.aspx.cs" Inherits="Pages_Porting_Data"  %>
                 ...
                 <div class="card">
                    <%--    <div class="card-header">
                        ...
                        <table><tr><td style="height: 35px">
                            <asp:Button ID="btnBank"  CssClass="btn btn-secondary btn-sm" runat="server" Text=" നീക്കിയിരിപ്പ് വിശദാംശം  (RP 40(a) പ്രകാരം)" Width="348px" OnClick="btnBank_Click" /> </td>
