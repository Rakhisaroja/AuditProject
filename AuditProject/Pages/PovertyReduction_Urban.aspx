<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="PovertyReduction_Urban.aspx.cs" Inherits="Pages_PovertyReduction_Urban"  %>
                ...
                <%--<div class="title-blue-Head">വരവ് ഭാഗം
                    ...
                    <div class="card">
                        ...
                        <DIV style="OVERFLOW: scroll; WIDTH: 1200px;height:500px" >
                          <asp:Repeater ID="grvPovertyReduction" runat="server" >
