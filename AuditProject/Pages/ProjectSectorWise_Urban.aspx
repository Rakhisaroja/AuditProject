<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="ProjectSectorWise_Urban.aspx.cs" Inherits="Pages_ProjectSectorWise_Urban" %>
...
<div class="content mt-3">
        ...
        <strong class="card-titlen" >Standing Committee</strong>    
        <asp:DropDownList ID="ddlStandingCommittee" runat="server" AutoPostBack="True" Width="300px" OnSelectedIndexChanged="ddlStandingCommittee_SelectedIndexChanged">
        </asp:DropDownList> 
        
        <strong class="card-titlen">Sector</strong>    
        <asp:DropDownList ID="ddlSector" runat="server" AutoPostBack="True" Width="300px" OnSelectedIndexChanged="ddlSector_SelectedIndexChanged">
        </asp:DropDownList> 
        ...
        <div class="card">
                       ...
                       <div class="table table-striped table-bordered">
                        <div style="OVERFLOW: scroll; WIDTH: 1200px;height:400px" >
