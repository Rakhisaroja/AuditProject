<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="PublicWorkingGroup_Urban.aspx.cs" Inherits="Pages_PublicWorkingGroup_Urban"  %>
...
<div class="content mt-3">
                ...
                <div class="title-blue-Head">ചെലവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen">ഇ) മരാമത്ത്  സ്റ്റാന്റിംഗ് കമ്മിറ്റി</strong>
                        </div><div class="card-header">
                            <strong class="card-titlen">ഇ (i) വര്‍ക്കിംഗ് ഗ്രൂപ്പുകള്‍</strong>
                        </div>
                       ...
                       <%-- <th  >ക്രമ നമ്പര്‍</th>--%> <td   style="width:50px">
                        ...
                        <td style="width: 362px; height: 28px;" align="left"  > 
                            <strong><span style="font-size: 12pt; font-family: Meera;
                                        ...
                                        mso-bidi-language: ML"><strong><span style="color: #000000"><span lang="ML"><asp:Label ID="Label2" runat="server" Text="2. ചെയര്‍മാന്‍(പേര് വിവരം)" Font-Bold="True" Width="200px" />(*)</span></span></strong></span></strong></td>
                       <td align="left"><asp:TextBox ID="txtChairMan"   runat="server" Text= "" Width="413px" /></td>
                        ...
                        <td style="width: 362px; height: 28px;" align="left" > 
                            <strong>
                                <span style="font-family: Meera"><span style="color: #000000"><span lang="ML"><asp:Label ID="Label3" runat="server" Text="3. കണ്‍വീനര്‍ (പേര് വിവരം)" Font-Bold="True" Width="220px" />(*)</span><o:p></o:p></span></span></strong></td>
                       <td align="left"><asp:TextBox ID="txtConveneor" runat="server" Text= "" Width="413px" TextMode="MultiLine" /></td>
                        </tr>
                             <tr>
                          <td   style="width:50px">
                            &nbsp;</td>
                       ...
                       <td align="left"><asp:TextBox ID="txtnoofMeeting"    Width="300px" TextMode="multiLine"   runat="server" Text= ""   /></td>
                        </tr>
                             <tr>
                          <td   style="width:50px">
                            &nbsp;</td>
    ...
    <ItemTemplate>
            ...
            <td><asp:Label ID="txtGroupName" Width="300px" runat="server" TextMode="multiline" ReadOnly="true" Text='<%# Eval("nchvWorkingGroup") %>' />
            ...
            <td><asp:TextBox ID="chvnameofchairman" Width="300px"  TextMode="multiline" runat="server" Text='<%# Eval("chvnameofchairmanmal") %>' /></td>
             <td>
                <asp:TextBox ID="chvnameofconvenor" Width="300px"  TextMode="multiline" runat="server" Text='<%# Eval("chvnameofconvenormal") %>' />
            </td>
            <td>
        ...
        <td><asp:Label ID="TextBox1" runat="server" Text='<%# Eval("nchvWorkingGroup") %>' />
            <td><asp:TextBox ID="chvAuditnameofchairman" Width="300px"  TextMode="multiline" runat="server" Text='<%# Eval("chvAuditnameofchairmanmal") %>' /></td>
             <td>
                <asp:TextBox ID="chvAuditnameofconvenor" Width="300px"   TextMode="multiline" runat="server" Text='<%# Eval("chvAuditnameofconvenormal") %>' />
            </td>
            <td>
...
<FooterTemplate></table></FooterTemplate>
...
</div></div><div style="width:100%"><table style="width: 1218px"><tr><td align="center">
     ...
     <asp:Button ID="btnNext" runat="server" CssClass="btn btn-secondary btn-sm" OnClick="btnNext_Click"
         Text="NEXT" Width="63px" /></td></tr>
         <tr><td></td></tr></table></div></div></div>
