<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="SchoolList.aspx.cs" Inherits="Pages_SchoolList"   %>
...
<div class="content mt-3">
                   ...
                   ചെലവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen">4.1 വിദ്യാഭ്യാസം</strong>
                        </div>
                       ...
                       <td><asp:TextBox ID="txtnoofStudent" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text= "" Width="80px" MaxLength="5" /></td>
                        </tr>
                       ...
                       <td><asp:TextBox ID="txtnoofTeacher" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text= "" Width="80px" MaxLength="5" /></td>
                        </tr>
                             <tr>
                       ...
                       <td style="height: 29px" align="left"><asp:TextBox ID="txtnoofFurniture" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="80px" MaxLength="5" /></td>
                        </tr>
                            <tr>
                                <td style="width: 50px">
                                </td>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtnoofToilet" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="80px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                <td style="width: 50px">
                                </td>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtnoofWashbase" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text= "" Width="80px" MaxLength="5" /></td>
                            </tr>
                            <tr>
                                <td style="width: 50px">
                                </td>
    ...
    <td>
                <asp:TextBox ID="intstudentcount" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("intstudentcount") %>' />
            </td>
             <td>
                <asp:TextBox ID="intteacherscount" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("intteacherscount") %>' />
            </td>
            <td>
            ...
            <td>
             ...
             <td>
                <asp:TextBox ID="intfurniture" MaxLength="5" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text='<%# Eval("intfurniture") %>' />
            </td>
            <td>
                <asp:TextBox ID="inttoilet" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("inttoilet") %>' />
            </td>
            <td>
                <asp:TextBox ID="intwashbasin" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("intwashbasin") %>' />
            </td>
    ...
    <td>
                <asp:TextBox ID="intstudentcountaudit" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("intstudentcountaudit") %>' />
            </td>
             <td>
                <asp:TextBox ID="intteacherscountaudit" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("intteacherscountaudit") %>' />
            </td>
            <td>
            ...
            <td>
             ...
             <td>
                <asp:TextBox ID="intfurnitureaudit" MaxLength="5" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" runat="server" Text='<%# Eval("intfurnitureaudit") %>' />
            </td>
            <td>
                <asp:TextBox ID="inttoiletaudit" MaxLength="5" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("inttoiletaudit") %>' />
            </td>
            <td>
                <asp:TextBox ID="intwashbasinaudit" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric" Text='<%# Eval("intwashbasinaudit") %>' />
            </td>
