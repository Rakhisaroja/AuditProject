<%@ Page Language="C#"MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="SocialJusticeChildAged.aspx.cs" Inherits="AuditProject_Pages_SocialJusticeChildAged" Title="Untitled Page" %>
...
<div class="card-header">
 <strong class="card-titlen"> 2(b)കുട്ടികള്‍,വൃദ്ധര്‍,ട്രാന്‍സ്ജെന്‍ഡേർസ് -പ്രോജക്ടുകളുടെ വിവരങ്ങള്‍</strong>
 </div>  
 <div class="card-header">
 <strong class="card-titlen">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 2(b)(1) കുട്ടികള്‍ക്ക് വേണ്ടി നടപ്പിലാക്കിയ പ്രോജക്ടുകള്‍</strong>
 </div>  
  <div class="card-body">
