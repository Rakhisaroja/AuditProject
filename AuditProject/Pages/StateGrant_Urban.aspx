<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="StateGrant_Urban.aspx.cs" Inherits="Pages_StateGrant_Urban"   %>
...
<div class="content mt-3">
        ...
        <table cellspacing="0" rules="all" border="1" style="font-size: 20px;font-family: Meera; vertical-align:middle" >
                ...
                <th scope="col" style="width: 400px" align="center" colspan="7">  നിലവിലുള്ള വിവരങ്ങള്‍                 
                </th>            
                <th scope="col" style="width: 400px"  align="center" colspan="7">     ഓഡിറ്റില്‍ കണ്ടെത്തിയ വിവരങ്ങള്‍              
                </th> 
    ...
    <%--        <td>
                <asp:TextBox ID="fltYearly"  Width="200px" runat="server"  CssClass="floatnumbers" />
            </td>
            <td>
                <asp:TextBox ID="fltYearlyexpense"  Width="200px" runat="server"  CssClass="floatnumbers" />
            </td>
            --%>
    ...
    <td> <asp:TextBox ID="fltaudbudget" Width="400px" runat="server" Text='<%# Eval("fltaudbudget") %>'  CssClass="floatnumbers" />
           ...
           <%--  <td>
                <asp:TextBox ID="fltAuditYearly"  Width="200px" runat="server"  CssClass="floatnumbers" />
            </td>
            <td>
                <asp:TextBox ID="fltAuditYearlyexpense"  Width="200px" runat="server"  CssClass="floatnumbers" />
            </td>
            --%>
