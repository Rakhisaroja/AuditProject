<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="TaxNonTaxAcrual.aspx.cs" Inherits="Pages_TaxNonTaxAcrual"  %>
            ...
            <tr>
              ...
              <%--  <th></th>--%>
               ...
               <%-- <th></th>--%>
                   <th scope="col" style="width: 100px ;text-align:center"  align="center">
                    തന്‍വര്‍ഷം തന്‍വര്‍ഷത്തേക്ക് ലഭിച്ച തുക (current) (റസീറ്റ് ആന്റ് പേമെന്റ് അക്കൌണ്ട് പ്രകാരം -ആര്‍.പി-43)<br /><label> [a]</label>
                </th>
                   <th scope="col" style="width: 100px  ;text-align:center" align="center">
                    തന്‍വര്‍ഷം മുന്‍വര്‍ഷങ്ങളിലേക്ക് ലഭിച്ച തുക (arrear)    (റസീറ്റ് ആന്റ് പേമെന്റ് അക്കൌണ്ട് പ്രകാരം -ആര്‍.പി-43, ആര്‍.പി-1  ) <br /><label>[b]</label>
                </th>
                 <th scope="col" style="width: 100px  ;text-align:center" align="center">
                    തന്‍വര്‍ഷം അടുത്ത വര്‍ഷങ്ങളിലേക്ക് ലഭിച്ച തുക (advance)       (ആര്‍.പി-36)<br />[c]
                </th>
              ...
              <%--  <th></th>--%>
               ...
               <%-- <th></th>--%>
                 ...
                 <th scope="col" style="width: 100px  ;text-align:center" align="center">
                    തന്‍വര്‍ഷം അടുത്ത വര്‍ഷങ്ങളിലേക്ക് ലഭിച്ച തുക (advance)       (ആര്‍.പി-36)<br /><label>[c]</label>
                </th>
                 <th scope="col" style="width: 100px" align="center">
                   ആകെ തന്‍വര്‍ഷം വരവ്<label>(a+b+c)</label> 
                </th>
