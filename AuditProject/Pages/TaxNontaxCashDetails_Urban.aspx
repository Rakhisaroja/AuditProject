<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="TaxNontaxCashDetails_Urban.aspx.cs" Inherits="Pages_TaxNontaxCashDetails_Urban"  %>
...
(റസീറ്റ് ആന്റ് പേമന്റ് അക്കൌണ്ട് പ്രകാരം )
    ...
    <ItemTemplate>
            ...
            <td><asp:TextBox ID= "numCurrentamount" ReadOnly="true" runat="server" Text='<%# Eval("numCurrentamount") %>' CssClass="floatnumbers"/></td>
             <td>
            ...
            <td>
                <asp:TextBox ID= "numauditedcurrentamount" ReadOnly="true" runat="server" Text='<%# Eval("numauditedcurrentamount") %>' CssClass="floatnumbers"/>
            </td>
