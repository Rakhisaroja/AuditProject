<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="Townplngartscltureprojdet_Urban.aspx.cs" Inherits="Pages_Townplngartscltureprojdet_Urban"  %>
                    ...
                    <div class="title-blue-Head">ചെലവ് ഭാഗം
                        ...
                        <div class="card">
                           <div class="card-header">
                                <strong class="card-titlen">2.കല സംസ്ക്കാരം, പുരാവസ്തു സംരക്ഷണം</strong>
                       ...
                       <div> <table width="100%"> <tr> 
                                ...
                                <td style="width: 1200px; height: 51px;" align="Center">
                                   ...
                                   <asp:Button
                                    ...
                                    TabIndex="10"
                                    Text="SAVE" />
                                    <asp:Button ID="btnNxt" runat="server" CssClass="btn btn-secondary btn-sm" OnClick="btnNxt_Click" Visible="false"
