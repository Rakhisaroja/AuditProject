<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="WasteProcessProjDet_Urban.aspx.cs" Inherits="Pages_WasteProcessProjDet_Urban"  %>
                    ...
                    <div class="title-blue-Head">ചെലവ് ഭാഗം
                        ...
                        <div class="card">
                         <div class="card-header">
                                <strong class="card-titlen">3. മാലിന്യസംസ്ക്കരണം</strong>
                       ...
                       <div class="table table-striped table-bordered">
                        <DIV style="OVERFLOW: scroll; WIDTH: 1200px;height:500px" >
                           ...
                           <asp:Repeater ID="rptCln" runat="server"    >
