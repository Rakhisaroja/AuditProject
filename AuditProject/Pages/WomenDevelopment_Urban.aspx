<%@ Page Language="C#" MasterPageFile="~/Pages/AuditMasterPage.master" AutoEventWireup="true" CodeFile="WomenDevelopment_Urban.aspx.cs" Inherits="Pages_WomenDevelopment_Urban" %>
                ...
                <div class="title-blue-Head">ചെലവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen"> 3. വനിതാവികസനം</strong>
                        </div>
                         <div class="card-header">
                            <strong class="card-titlen">&nbsp &nbsp &nbsp  മേഖല ദാരിദ്ര്യനിര്‍മാര്‍ജനം</strong>
                        </div>
                         <div class="card-header">
                            <strong class="card-titlen"> &nbsp &nbsp &nbsp   ചുമതല – സ്ത്രീകള്‍ക്ക്  സ്വയംതൊഴിലും ഗ്രൂപ്പ് എംപ്ലോയ്മെന്റും</strong>
                        </div>
                         <div class="card-header">
                            <strong class="card-titlen">&nbsp &nbsp &nbsp വനിതാഘടകപദ്ധതിയില്‍ ഉള്‍പ്പെടുത്തിയ പ്രോജക്ടുകള്‍</strong>
                        </div>
                        <div class="card-body">
                        <div class="table table-striped table-bordered">
                        <DIV style="OVERFLOW: scroll; WIDTH: 1200px;height:500px" >
                          <asp:Repeater ID="grvWomenDevelop" runat="server" >
