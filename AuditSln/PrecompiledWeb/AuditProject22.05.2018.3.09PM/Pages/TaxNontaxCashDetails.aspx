<%@ page language="C#" masterpagefile="~/Pages/AuditMasterPage.master" autoeventwireup="true" inherits="Pages_TaxNontaxCashDetails, App_Web_cllhm4gw" title="Untitled Page" %>
...
(റസീറ്റ് ആന്റ് പേമന്റ് അക്കൌണ്ട് പ്രകാരം )
    ...
    <ItemTemplate>
            ...
            <td><asp:TextBox ID= "numCurrentamount" runat="server" Text='<%# Eval("numCurrentamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/></td>
             <td>
            ...
            <td>
                <asp:TextBox ID= "numauditedcurrentamount" runat="server" Text='<%# Eval("numauditedcurrentamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
