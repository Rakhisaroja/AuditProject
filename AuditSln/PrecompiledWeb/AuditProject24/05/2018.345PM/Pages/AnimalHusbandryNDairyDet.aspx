<%@ page language="C#" masterpagefile="~/Pages/AuditMasterPage.master" autoeventwireup="true" inherits="Pages_AnimalHusbandryNDairyDet, App_Web_yasbjxhy" title="Untitled Page" %>
                    ...
                    prefix="o" ?><o:p></o:p></span></p>
                       ...
                       <div class="table table-striped table-bordered">
                        <DIV style="OVERFLOW: scroll; WIDTH: 1200px;height:300px" >
                           ...
                           <asp:Repeater ID="rptAnDa" runat="server"    >
...
<div> <table width="100%"> <tr> <td style="width: 53px; height: 51px;">
                               <asp:Button
                                    ID="Button1"
                                    runat="server"
                                    CssClass="lblMal"
