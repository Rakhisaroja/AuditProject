<%@ page language="C#" masterpagefile="~/Pages/AuditMasterPage.master" autoeventwireup="true" inherits="Pages_IrrigationDetails, App_Web_yasbjxhy" title="Untitled Page" %>
    ...
    <o:p></o:p></span></p>
        ...
        <tr>
         <th scope="col"  rowspan="3" align="center"  >
                    ക്രമ. നം
                </th> <th scope="col"  rowspan="3" align="center"  >
           ...
           <td>
            ...
            <td>
                <asp:Label ID="chvProjectName" runat="server" Text='<%# Eval("chvProjectName") %>' />
                 <asp:Label ID="decProjectID" runat="server" Text='<%# Eval("decProjectID") %>' Visible="false" />
            </td>
            <td>
