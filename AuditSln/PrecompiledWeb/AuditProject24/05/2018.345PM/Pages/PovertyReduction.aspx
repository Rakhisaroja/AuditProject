<%@ page language="C#" masterpagefile="~/Pages/AuditMasterPage.master" autoeventwireup="true" inherits="Pages_PovertyReduction, App_Web_yasbjxhy" title="Untitled Page" %>
                ...
                <%--<div class="title-blue-Head">വരവ് ഭാഗം
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-titlen"> 1. ദാരിദ്ര്യ ലഘൂകരണം</strong>
                        </div>
                        <div class="card-body">
                        <div class="table table-striped table-bordered">
                        <DIV style="OVERFLOW: scroll; WIDTH: 1200px;height:500px" >
                          <asp:Repeater ID="grvPovertyReduction" runat="server" OnItemCommand="grvMergeHeader_ItemCommand"   >
    <HeaderTemplate>
