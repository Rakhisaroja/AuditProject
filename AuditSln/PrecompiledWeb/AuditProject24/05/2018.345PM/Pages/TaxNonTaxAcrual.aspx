<%@ page language="C#" masterpagefile="~/Pages/AuditMasterPage.master" autoeventwireup="true" inherits="Pages_TaxNonTaxAcrual, App_Web_yasbjxhy" title="Untitled Page" %>
...
<div class="content mt-3">
    ...
    <ItemTemplate>
            ...
            <td><asp:TextBox ID= "txtincomeExpnditureamount" ReadOnly="true" runat="server" Text='<%# Eval("numincomeExpnditureamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/></td>
             <td>
                <asp:TextBox ID= "txtnumCurrentamount" ReadOnly="true"  runat="server" Text='<%# Eval("numCurrentamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
            <td>
                <asp:TextBox ID= "txtnumArrearamount" ReadOnly="true" runat="server" Text='<%# Eval("numArrearamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
             <td>
               <asp:TextBox ID= "txtnumAdvanceamount" ReadOnly="true" runat="server" Text='<%# Eval("numAdvanceamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
             <td>
                <asp:TextBox ID= "txtnumTotalamount" ReadOnly="true" runat="server" Text='<%# Eval("numTotalamount") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
            <td>
            ...
            <asp:Label ID="Label5" runat="server" Text='<%# Eval("vchaccountheadcode") %>' Visible="false" />
             ...
             <td>
                 <asp:TextBox ID= "txtincomeExpnditureamountAudt" ReadOnly="true" runat="server"  Text='<%# Eval("numincomeExpnditureamountAudt") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
             <td>
                <asp:TextBox ID= "txtnumCurrentamountAudt" ReadOnly="true" runat="server"  Text='<%# Eval("numCurrentamountAudt") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
                 <td>
                  <asp:TextBox ID= "txtnumArrearamountAudt" ReadOnly="true"  runat="server"  Text='<%# Eval("numArrearamountAudt") %>'  onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
                 <td>
                <asp:TextBox ID= "txtnumAdvanceamountAudt" ReadOnly="true" runat="server"  Text='<%# Eval("numAdvanceamountAudt") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
                 <td>
               <asp:TextBox ID= "txtnumTotalamountAudt" ReadOnly="true" runat="server"   Text='<%# Eval("numTotalamountAudt") %>' onkeypress="return  isNumberKey(event)" CssClass="txtBoxNumeric"/>
            </td>
